...
\begin{figure*}[t]
\centering
\includegraphics[width=0.23\linewidth]{figures/case_woman_shirt_original.png}
\includegraphics[width=0.23\linewidth]{figures/case_woman_shirt_mask.png}
\includegraphics[width=0.23\linewidth]{figures/case_woman_shirt_baseline.png}
\includegraphics[width=0.23\linewidth]{figures/case_woman_shirt_ours.png}\\
\includegraphics[width=0.23\linewidth]{figures/case_dog_robot_original.png}
\includegraphics[width=0.23\linewidth]{figures/case_dog_robot_mask.png}
\includegraphics[width=0.23\linewidth]{figures/case_dog_robot_baseline.png}
\includegraphics[width=0.23\linewidth]{figures/case_dog_robot_ours.png}\\
\includegraphics[width=0.23\linewidth]{figures/case_car_hover_original.png}
\includegraphics[width=0.23\linewidth]{figures/case_car_hover_mask.png}
\includegraphics[width=0.23\linewidth]{figures/case_car_hover_baseline.png}
\includegraphics[width=0.23\linewidth]{figures/case_car_hover_ours.png}
...
\item Collect the PNGs for each example (e.g., \texttt{case\_woman\_shirt\_original.png}, \texttt{case\_woman\_shirt\_mask.png}, \texttt{case\_woman\_shirt\_baseline.png}, \texttt{case\_woman\_shirt\_ours.png}) for the final report or README.
\end{enumerate}
